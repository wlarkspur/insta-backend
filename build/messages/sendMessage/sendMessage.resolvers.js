...
exports.default = {
    Mutation: {
        sendMessage: (0, users_utils_1.protectedResolver)((_1, _a, _b) => __awaiter(void 0, [_1, _a, _b], void 0, function* (_, { payload, roomId, userId }, { loggedInUser }) {
            let room = null;
            if (userId) {
            ...
            pusub_1.default.publish(constants_1.NEW_MESSAGE, { roomUpdates: Object.assign({}, message) });
            return {
                ok: true,
                id: message.id,
            };
